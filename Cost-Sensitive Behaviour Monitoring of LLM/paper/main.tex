...
\caption{Hypothetical prior over the four hidden states.}
\end{table}
...
\subsection{Joint initial evidence model}
...
\subsection{Worked posterior example}
...
\caption{Posterior for the worked joint-evidence example.}
\end{table}
...
\caption{Expected information gain of candidate probes at the prior.}
\end{table}


These values are calculated from the learned synthetic observation model. They are not production information rates.

\subsection{Value of information versus information gain}
...
\subsection{Four-state cost model}
...
\caption{State-aware action costs used by the main policy.}
\end{table}
...
\subsection{Training, development, and test separation}
...
\caption{Development-split selection of the investigation cost.}
\end{table}
...
\subsection{Seed-7 diagnostic runs}
...
\subsection{Twenty-seed held-out evaluation}
...
\caption{Twenty-seed held-out comparison. Entries are means plus or minus 95 percent t confidence intervals.}
\end{table*}
...
\subsection{Calibration and correlated evidence}
...
\caption{Brier error across 20 held-out seeds.}
\end{table}
...
\subsection{Investigation-cost sensitivity}
...
\caption{Investigation-cost sensitivity on the 50-case seed-7 benchmark.}
\end{table*}
...
\caption{Representative failure cases from the revised benchmark.}
\end{table*}
